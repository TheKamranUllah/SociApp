...
public class CommentDeletionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comment_deletion);
        ...
        View view = LayoutInflater.from(CommentDeletionActivity.this).inflate(R.layout.dialog_two_btns_layout, null);
        android.app.AlertDialog.Builder mbuilder = new android.app.AlertDialog.Builder(CommentDeletionActivity.this, R.style.mydialog);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(CommentDeletionActivity.this);
        builder.setTitle("Edit Post!");

        final EditText inputField = new EditText(CommentDeletionActivity.this);
        ...
        builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(CommentDeletionActivity.this, "Comment Updated Successfully!", Toast.LENGTH_SHORT).show();
           ...
           CancelButton.setText("Cancel");
            ...
            OkButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(CommentDeletionActivity.this, "Comment Deleted Successfully!", Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                }
            });
            ...
            CancelButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(CommentDeletionActivity.this, "You Pressed Cancel!", Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                    SendUserToCommentActivity(ThePostkey);
                }
            });
            ...
            Toast.makeText(CommentDeletionActivity.this, "This is not your Comment!", Toast.LENGTH_SHORT).show();
        }
    ...
    private void SendUserToCommentActivity(String Postkey) {
        ...
        Intent MainIntent = new Intent(CommentDeletionActivity.this, CommentsActivity.class);
