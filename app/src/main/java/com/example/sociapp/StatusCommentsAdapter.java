...
public class StatusCommentsAdapter extends RecyclerView.Adapter<StatusCommentsAdapter.CommentsViewHolder> {
    ...
    public StatusCommentsAdapter(String statusKey, List<String>commentKeys, List<Comments> mList, Context context) {

        this.mList = mList;
        this.context = context;
        this.commentsKeys = commentKeys;
        this.CommentPostKey = statusKey;
    }
    ...
    public void onBindViewHolder(@NonNull CommentsViewHolder holder, final int position) {
        ...
        final String TheStatusCommentKey = CommentPostKey;
        ...
        commentRef = FirebaseDatabase.getInstance().getReference().child("Posts").child(TheStatusCommentKey).child("Comments")
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                if (currentUserId.equals(commentedUerId)) {
                    Intent CommentdeletionIntent = new Intent(context, StatusCommentDActivity.class);
                    CommentdeletionIntent.putExtra("PostKey", TheStatusCommentKey);
                    ...
                    ((StatCommentActivity) context).finish();
                }
                else
                {
